...
loginApp.controller('RegistrationController', function($scope, $rootScope,
		$http, $location, $timeout, Backand) {
	$(function() {
	...
	$scope.register = function() {
		...
		$scope.backandSignup($scope.userInput.FirstName,
				$scope.userInput.LastName, $scope.userInput.UserName,
				$scope.userInput.Password, $scope.userInput.ConfirmPassword, {
	...
	$scope.backandSignup = function(FirstName, LastName, UserName, Password,
			ConfirmPassword, extraObj) {
		Backand.signup(FirstName, LastName, UserName, Password,
				ConfirmPassword, extraObj).then(function(response) {
			console.log(response);
	...
	$scope.login = function() {
		Backand.signin($scope.username, $scope.password).then(
				function(response) {
					console.log(response);
